...
open class Node: Equatable, Hashable {
    ...
    public subscript(dynamicMember member: String) -> String {
        get {
            return attributes?.get(key: member) ?? ""
        }
        set {
            try? attributes?.put(member, newValue)
        }
    }
    ...
    internal(set) public var attributes: Attributes?
    var baseUri: String?
	...
	*/
    ...
    init(_ baseUri: String, _ attributes: Attributes, _ childNodes: [Node]) {
    ...
    open func attrGetResult(_ attributeKey: String) -> Result<String, Swift.Error> {
        let f: (String) throws -> String = Node.attr(self)
        return .init(catching: { try f(attributeKey) })
    }
    ...
    @discardableResult
    open func attrSetResult(_ attributeKey: String, _ attributeValue: String) -> Result<Node,Swift.Error> {
        let f: (String,String) throws -> Node = Node.attr(self)
        return .init(catching: { try f(attributeKey, attributeValue) })
    }
    /**
    ...
    @discardableResult
    open func removeAttrResult(_ attributeKey: String) -> Result<Node,Swift.Error> {
        let f = Node.removeAttr(self)
        return .init(catching: {try f(attributeKey) })
    }
    /**
    ...
    open func setBaseUriRsult(_ baseUri: String) -> Result<Void,Swift.Error> {
        let f = Node.setBaseUri(self)
        return .init(catching: { try f(baseUri) })
    }
    /**
    ...
    open func absUrlResult(_ attributeKey: String) -> Result<String,Swift.Error> {
        let f = Node.absUrl(self)
        return .init(catching: {try f(attributeKey) })
    }
    /**
    ...
    open var removeResult: Result<Void,Swift.Error> {
        return .init(catching: Node.remove(self))
    }
