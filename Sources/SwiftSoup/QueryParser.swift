...
public class QueryParser {
    ...
    public static func parseResult(_ query: String) -> Result<Evaluator, Swift.Error> {
        return .init(catching: {try QueryParser(query).parse()})
    }
    /**
     * Parse the query
     * - Returns: Evaluator
    ...
    public var parseResult: Result<Evaluator,Swift.Error> {
        return .init(catching: QueryParser.parse(self))
    }
    ...
    private func combinatorResult(_ combinator: Character) -> Result<Void,Swift.Error> {
        return Result<(), Swift.Error> { try self.combinator(combinator) }
    }
    ...
    private var findElementsResult: Result<Void, Swift.Error> {
        return .init(catching: QueryParser.findElements(self))
    }
    ...
    private var byIDResult: Result<Void,Swift.Error> {
        return .init(catching: QueryParser.byId(self))
    }
    ...
    private var byClassResult: Result<Void, Swift.Error> {
        return .init(catching: QueryParser.byClass(self))
    }
    ...
    private var byTagResult: Result<Void,Swift.Error> {
        return .init(catching: QueryParser.byTag(self))
    }
    ...
    private var byAttributeResult: Result<Void,Swift.Error> {
        return .init(catching: QueryParser.byAttribute(self))
    }
    ...
    private var indexLessThanResult: Result<(),Swift.Error> {
        return .init(catching: QueryParser.indexLessThan(self) )
    }

    private func indexGreaterThan()throws {
        evals.append(Evaluator.IndexGreaterThan(try consumeIndex()))
    }
    private var indexGreaterThanResult: Result<(),Swift.Error> {
        return .init(catching: QueryParser.indexGreaterThan(self) )
    }
    ...
    private var indexEqualsResult: Result<(),Swift.Error> {
        return .init(catching: QueryParser.indexEquals(self) )
    }
    ...
    private func cssNthChildResult(_ backwards: Bool, _ ofType: Bool) -> Result<Void,Swift.Error> {
        return .init(catching: { try self.cssNthChild(backwards, ofType) })
    }
    ...
    private var consumeIndexResult: Result<Int, Swift.Error> {
        return .init(catching: QueryParser.consumeIndex(self) )
    }
    ...
    private var hasResult: Result<Void,Swift.Error> {
        return .init(catching: QueryParser.has(self))
    }
    ...
    private func containsResult(_ own: Bool) -> Result<Void,Swift.Error> {
        return .init(catching: {try self.contains(own)})
    }
    ...
    private func matchesResult(_ own: Bool) -> Result<Void,Swift.Error> {
        return .init(catching: {try self.matches(own) })
    }
    ...
    private var notResult: Result<Void, Swift.Error> {
        return .init(catching: QueryParser.not(self) )
    }
}
